...
# Run backup on both virtual machine: box1 and box2
...
box1.vm.network :forwarded_port, guest: 22, host: 10124, id: "ss"
box1.vm.netowrk :private_network, ip: "192.168.56.101"
box1.vm.provider :virtualbox do |v|
v.customixe ["modifyvm", :id, "--memory", 1020]
end
end
...
#SHELL
box2.vm.provision "shell", path "apache_script.sh"
